...
// import { generatePDF } from '../utils/pdfGenerator.mjs'; // or .js
// import LoanRequest from '../models/LoanRequest.mjs'; // 
...
export const generateLoanPDF = async (req, res) => {
  try {
    const { loanRequestId } = req.params; // Fixed parameter name (camelCase)
